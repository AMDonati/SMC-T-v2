...
#SBATCH --output=slurm_out/sst/multiD-noise-smc_t0.1-%j.out
#SBATCH --error=slurm_out/sst/multiD-noise-smc_t0.1-%j.err
...
OUTPUT_PATH="output/NLP/CLEVR/multiD_noise"
D_MODEL=32
DFF=32
BS=32
PARTICLES=10
