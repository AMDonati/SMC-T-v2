#!/bin/bash
#SBATCH --job-name=INITWEIGHTS-ft-gpt2dec-ROC-smc-t-None
#SBATCH --qos=qos_gpu-t4
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem-per-cpu=16g
#SBATCH --output=slurm_out/sst/ROC-smc_t-None-FT-INITWEIGHTS%j.out
#SBATCH --error=slurm_out/sst/ROC-smc_t-None-FT-INITWEIGHTS-%j.err
