#!/bin/bash
#SBATCH --job-name=drop0.5-dim128-ROC-smc-t-None
#SBATCH --qos=qos_gpu-t3
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem-per-cpu=8g
#SBATCH --output=slurm_out/sst/drop0.5-ROC-smc_t-None-%j.out
#SBATCH --error=slurm_out/sst/drop0.5-ROC-smc_t-None-%j.err
