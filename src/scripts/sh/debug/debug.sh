...
python src/scripts/run.py -dataset "covid" -data_path "data/covid" -algo "smc_t" -d_model 8 -dff 8 -num_heads 4 -bs 64 -ep 1 -output_path "output/temp" -particles 2 -smc True -multistep 1 -past_len 40 -mc_samples 5