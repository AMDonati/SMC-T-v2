...
python src/scripts/run.py -dataset "weather" -data_path "data/weather" -algo "smc_t" -d_model 32 -dff 32 -bs 256 -ep 50 -output_path "output/exp_weather" -particles 10 -smc True -save_path "output/exp_weather/smc_t_d32_p10/1" -mc_samples 1000 -past_len 12 -multistep 1

python src/scripts/run.py -dataset "weather" -data_path "data/weather" -algo "smc_t" -d_model 32 -dff 32 -bs 256 -ep 50 -output_path "output/exp_weather" -particles 10 -smc True -mc_samples 1000 -past_len 12 -multistep 1 -max_samples 10000 -num_layers 2 -num_heads 4

python src/scripts/run.py -dataset "weather" -data_path "data/weather" -algo "smc_t" -d_model 32 -dff 32 -bs 256 -ep 50 -output_path "output/exp_weather" -particles 10 -smc True -mc_samples 1000 -past_len 12 -multistep 1 -max_samples 10000