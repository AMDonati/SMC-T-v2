...
python src/scripts/run.py -dataset "weather" -data_path "data/weather_vm3" -algo "lstm" -rnn_units 32 -bs 256 -ep 50 -output_path "output/exp_weather_lstm" -p_drop 0.5 -mc_samples 1000 -multistep 1 -past_len 12