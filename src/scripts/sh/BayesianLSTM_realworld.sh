...
python src/scripts/run.py -dataset "weather" -dataset_model 1 -data_path "data/weather" -algo "bayesian_lstm" -rnn_units 32 -bs 256 -ep 50 -output_path "output/exp_weather" -mc_samples 1000 -particles 3 -max_samples 50000 -save_path "output/exp_weather/bayesian_lstm_d32/1" -past_len 12 -multistep 1
